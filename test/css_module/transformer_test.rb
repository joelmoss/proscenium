...
class Proscenium::CssModule::TransformerTest < ActiveSupport::TestCase
  describe '#class_names' do
    it 'transforms class names beginning with @' do
      ...
      assert_equal [['title_3977965b', '/lib/css_modules/basic.module.css']], names
    end
    ...
    it 'transforms class names beginning with @ and underscore' do
      ...
      assert_equal [['_title_3977965b', '/lib/css_modules/basic.module.css']], names
    end
    ...
    it 'accepts multiple names' do
      ...
      assert_equal ['title', ['subtitle_3977965b', '/lib/css_modules/basic.module.css']], names
    end
    ...
    context 'local path' do
      it 'transforms class names' do
        ...
        assert_equal [['title_32581d4c', '/lib/css_modules/basic2.module.css'],
                      ['subtitle_3977965b', '/lib/css_modules/basic.module.css']], names
      end
    ...
    context 'npm package path' do
      it 'transforms class names' do
        ...
        assert_equal [
          ['pkg_one_module_f52a8541', '/node_modules/pkg/one.module.css']
        ], names
      end
    ...
    context 'gem path' do
      it 'transforms class names' do
        ...
        assert_equal [['foo_b0953e88', '/gem2/lib/gem2/styles.module.css']], names
      end
  ...
  describe '.class_names' do
    context 'given path is nil' do
      ...
      it 'should transform local path' do
        ...
        assert_equal [['title_32581d4c', '/lib/css_modules/basic2.module.css']], names
      end

      it 'should transform npm path' do
        names = transformer.class_names('pkg/one@pkg_one_module')

        assert_equal [['pkg_one_module_f52a8541', '/node_modules/pkg/one.module.css']], names
      end
