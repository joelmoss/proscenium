...
describe("compilers/esbuild", () => {
  ...
  it("Import npm module", async (t) => {
    const result = await main("lib/import_node_module.js", {
      root,
      lightningcssBin,
    });
  ...
  it("allows returns error on unknown bare module", async (t) => {
    const result = await main("lib/import_unknown_node_module.js", {
      root,
      lightningcssBin,
    });
  ...
  it("resolves nested node modules", async (t) => {
    const result = await main("node_modules/@react-aria/button", {
      root,
      lightningcssBin,
    });
  ...
  it("Import relative module", async (t) => {
    const result = await main("lib/import_relative_module.js", {
      root,
      lightningcssBin,
    });
  ...
  it("Import absolute module", async (t) => {
    const result = await main("lib/import_absolute_module.js", {
      root,
      lightningcssBin,
    });
  ...
  it("Import remote module", async (t) => {
    const result = await main("lib/import_remote_module.js", {
      root,
      lightningcssBin,
    });
  ...
  it("npm module with relative import", async (t) => {
    const result = await main("lib/npm_module_with_relative_import.js", {
      root,
      lightningcssBin,
    });
