...
;(function () {
  ...
  const featureDetectionPromise = Promise.resolve(supportsDynamicImportCheck).then(
    _supportsDynamicImport => {
      ...
      return Promise.all([
        ...
        cssModulesEnabled &&
          dynamicImport(createBlob('import"data:text/css,{}"assert{type:"css"}')).then(
            () => (supportsCssAssertions = true),
            noop
          ),
        jsonModulesEnabled &&
          dynamicImport(createBlob('import"data:text/json,{}"assert{type:"json"}')).then(
  ...
  function parse(k, l = '@') {
    if (((t = k), (f = l), t.length > i || !e)) {
      ...
      ;(r = new ArrayBuffer(4 * i)),
        (e = (function (e, r, a) {
          ...
          function L(e) {
            e = e | 0
            if (!($(e, 119, 104, 105, 108, 101) | 0) ? !(P(e, 102, 111, 114) | 0) : 0)
              e = q(e, 105, 102) | 0
            else e = 1
            return e | 0
          }
    ...
    for (; e.ri(); ) {
      const r = e.is(),
        ...
        c = e.se()
      let n
      e.ip() && (n = u(-1 === s ? r : r + 1, t.charCodeAt(-1 === s ? r - 1 : r))),
      ...
      case 117:
        return (function () {
          ...
          123 === t.charCodeAt(c$1)
            ? (++c$1, (e = l(t.indexOf('}', c$1) - c$1)), ++c$1, e > 1114111 && h())
            : (e = l(4))
          return e <= 65535
  ...
  const resolve = resolveHook
    ? async (id, parentUrl) => ({ r: await resolveHook(id, parentUrl, defaultResolve), b: false })
    : _resolve
  ...
  async function doFetch(url, fetchOpts, parent) {
    if (enforceIntegrity && !fetchOpts.integrity) throw Error(`No integrity for ${url}`)
    ...
    } else throw Error(`Unsupported Content-Type "${contentType}"`)
  }
