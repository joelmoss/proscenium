...
module Proscenium::UI::Form
  ...
  # Rails form helpers.
  #
  # Start by creating the form with `Proscenium::UI::Form::Component`, which expects a model
  ...
  #
  class Component < Proscenium::UI::Component
    ...
    # Example:
    #
    #   render Proscenium::UI::Form::Component.new @resource do |f|
    ...
    def template(&block)
      form action:, method:, class: :@base, **@attributes do
        method_field
