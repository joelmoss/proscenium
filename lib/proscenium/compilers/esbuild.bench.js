...
Deno.bench('esbuild svg', async () => {
  await compile('at.svg', { root, lightningcssBin })
})

Deno.bench('bundle-all:date-fns tree shaking', async () => {
  await compile('lib/bundle_all_import/datefns.js', { root, lightningcssBin })
})
