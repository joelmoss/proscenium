...
/**
 ...
 the import map will not be used again in the returned path. The imports from the map are resolved
 in the context of the root (esbuild.absWorkingDir).
 */
